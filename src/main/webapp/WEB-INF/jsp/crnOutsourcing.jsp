...
CRN is able to provide GCP-compliant Toxicology & Safety Pharmacology services that include clinical project management and monitoring of these studies. Our vendor-independent clinical study safety monitoring services in India ensures that clinical study meets the requirements for US FDA, ICH, GCP guidelines Specific clinical project management & study monitoring services include: •	Prepare clinical Safety Plan according to Protocol and GCP guidelines •	Develop detailed Project Plan with activities, timelines and resources, including critical milestones and key decision points in the program •	Vendor-independent clinical safety monitoring in India •	Prepare, review, and edit the clinical monitoring report Manage the client/vendor relationship by monitoring vendor progress and keeping the client informed including troubleshoot technical issues
</p>
<h3>
...
<p>
We identify appropriate resources, vendors in India & the USA across drug development and manufacturing spectrum with strong networking and project management support that include: •	Drug Discovery - Chemistry & Biology •	Preclinical Development •	Chemistry, manufacture, and control (CMC) •	Clinical Development •	R&D Partnership •	 Regulatory Liaisoning & Consulting
</p>
</div>